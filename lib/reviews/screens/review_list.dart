...
class _ReviewPageState extends State<ReviewPage> {
  ...
  Future<void> getLoggedInUserInfo() async {
    ...
    var url =
        Uri.parse('http://10.0.2.2:8000/reviews/check-username-flutter/');
  ...
  Future<List<Review>> fetchReview(int pk) async {
    ...
    var url = Uri.parse('http://10.0.2.2:8000/reviews/get-review/$pk/');
  ...
  Future<void> deleteReview(int reviewId) async {
    CookieRequest request = CookieRequest();
    var url = Uri.parse('http://10.0.2.2:8000/reviews/delete-review-flutter/');
